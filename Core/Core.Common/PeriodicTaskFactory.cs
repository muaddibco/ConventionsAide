...
{
    /// <summary>
    /// Factory class to create a periodic Task to simulate a <see cref="Timer"/> using <see cref="Task">Tasks.</see>
    /// </summary>
    public static class PeriodicTaskFactory
    {
                                 ...
                                 TaskCreationOptions periodicTaskCreationOptions = TaskCreationOptions.None)
        {
            ...
            {
                MainPeriodicTaskAction(intervalInMilliseconds, delayInMilliseconds, duration, maxIterations, cancelToken, stopWatch, synchronous, () =>
            {
        ...
        public static Task Start(Action<object> action,
                                 ...
                                 bool synchronous = false,
                                 CancellationToken cancelToken = new CancellationToken(),
                                 TaskCreationOptions periodicTaskCreationOptions = TaskCreationOptions.None) => Task.Factory.StartNew(o =>
                                                                                                                              {
