...
using ConventionsAide.Core.Common.Guids;
...
namespace ConventionsAide.Core.EntityFrameworkCore.Repositories
{
        ...
        where TEntity : class, IEntity
    {
        ...
        {
            return _dbContextProvider.GetDbContextAsync<TDbContext>();
        }
        ...
        public EfCoreRepository(IDbContextProvider dbContextProvider, ILazyServiceProvider lazyServiceProvider)
